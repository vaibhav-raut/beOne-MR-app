...
public class OwnerMrAccountShortFragment extends MrAccountShortFragment {
    private static OwnerMrAccountShortFragment instance;

    public static OwnerMrAccountShortFragment newInstance() {

//        if(instance == null) {
            instance = new OwnerMrAccountShortFragment();
//        }
        return instance;
    }
