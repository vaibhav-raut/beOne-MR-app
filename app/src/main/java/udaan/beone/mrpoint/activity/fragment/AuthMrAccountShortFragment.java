...
public class AuthMrAccountShortFragment extends MrAccountShortFragment {

    public static AuthMrAccountShortFragment newInstance() {
        return new AuthMrAccountShortFragment();
    }
